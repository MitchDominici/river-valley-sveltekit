...
<div class="container mx-auto px-4 py-8 mt-16">
    {#if town}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Town Information Column -->
            <div class="bg-secondary-yellow rounded-lg shadow-lg p-6 border-2 border-dashed border-earthy-brown">
                <h1 class="text-5xl font-fun text-primary-blue mb-6">{town.name}</h1>
...
<!--                    &lt;!&ndash; Town Shape with Main Image &ndash;&gt;-->
